  ...
  return (
    <footer className="h-8 bg-[#0b0c0e]/85 backdrop-blur border-t border-white/5 px-6 hidden sm:flex items-center justify-between text-[11px] font-mono text-zinc-500 shrink-0 z-20 select-none">
      ...
      <div className="flex items-center space-x-4">
        ...
        <span>•</span>
        <span>Latency: <strong className="text-[#a3ff12]">9 ms</strong></span>
        <span>•</span>
      ...
      <div className="flex items-center space-x-4">
        ...
        <span>•</span>
        <button
          onClick={() => console.log("Guitar Studio Help & Documentation")}
          className="hover:text-white transition-colors uppercase font-bold cursor-pointer"
        >
          SUPPORT
        </button>
      </div>
